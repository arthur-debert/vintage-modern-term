// Amber Phosphor Monitor - Warm vintage terminal
...
const vec3 PHOSPHOR_COLOR = vec3(1.0, 0.7, 0.0);
...
const float SCANLINES = 0.35;    // 0.0 = none, 1.0 = dark lines
const float SCANLINE_SIZE = 0.33;// 0.0 = sparse, 1.0 = dense
const float NOISE = 0.07;        // 0.0 = clean, 1.0 = heavy static
const float FLICKER = 0.15;      // 0.0 = stable, 1.0 = heavy flicker
